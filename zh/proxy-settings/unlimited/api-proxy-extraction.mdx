---
title: "如何通过API提取使用不限量住宅代理？"
sidebarTitle: "API提取"
---

B2Proxy 支持通过 **API 提取方式（IP 白名单认证）** 使用不限量住宅代理，无需账号密码，配置更安全也更稳定。本文将介绍如何添加白名单 IP，并通过 API 成功提取不限量住宅代理，帮助您快速完成配置并开始使用。
